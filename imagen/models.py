...
class Path(models.Model):
    """
    Represents a single image generation event based on a final prompt.
    This model groups multiple generated images that belong to the same request.
    """
...
class GeneratedImage(models.Model):
    """
    Stores a single image file generated from a Path/Prompt.
    """
...
class ContentGeneration(models.Model):
    """
    Main model to manage the entire content creation lifecycle for an Instagram post.
    """
